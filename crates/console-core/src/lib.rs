...
pub use crate::audio::{
    ...
    NOTE_FREQ, PERIODIC_PERIOD, PERIODIC_TRANSPOSE_SEMIS, Pattern, PatternEnd, RAMP_SAMPLES,
    RowMod, SAMPLE_RATE, SAMPLES_PER_FRAME, SINE_QUARTER, Sfx, SfxRow, Sweep, TONE_CUTOFF_HZ,
