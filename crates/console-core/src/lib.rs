...
pub use crate::audio::{
    ...
    MAX_FM_RATIO_HALF, MAX_FX_SEMIS, MAX_HISS, MAX_ID, MAX_SFX_ROWS, MAX_TONE, MAX_VIB_CENTS,
    MAX_VIB_RATE, MAX_VOL, MIN_FM_RATIO_HALF, Master, NIBBLE_LEVEL, NOTE_FREQ, Pattern, PatternEnd,
    RAMP_SAMPLES, RowMod, SAMPLE_RATE, SAMPLES_PER_FRAME, SINE_QUARTER, Sfx, SfxRow, Sweep,
    TONE_CUTOFF_HZ, Tempo, Vib, WAVE_COUNT, WAVE_FM, WAVE_TABLE_BASE, WAVETABLE_LEN,
