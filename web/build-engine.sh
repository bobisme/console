...
-C link-arg=-sEXPORTED_FUNCTIONS=_main,_con_alloc,_con_free,_con_init,_con_step,_con_width,_con_height,_con_fb,_con_audio,_con_color_count,_con_palette,_con_dpal,_con_error \
